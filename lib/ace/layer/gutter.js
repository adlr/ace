...
(function() {
    ...
    this.update = function(config) {
        ...
        while (true) {
            ...
            var leadingSpace = "";
            if(firstPass) {
              var maxLineDigits = (this.session.getLength() + '').length;
              var currentDigits = ((i + 1) + '').length;
              var limit = 10;
              while (currentDigits < maxLineDigits) {
                if (limit-- < 0) {
                  break;
                }
                currentDigits++;
            ...
            html.push("<div class='ace_gutter-cell",
                ...
                "' style='height:", this.session.getRowLength(i) * config.lineHeight, "px;'>", leadingSpace, (i+1));
        ...
        this.element.parentNode.style.height = config.minHeight + "px";
